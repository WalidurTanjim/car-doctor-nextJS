...
const Navbar = () => {
    ...
    return (
        <Disclosure as="nav" className="bg-gray-800">
            <div className="container mx-auto w-full py-3 px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        {/* website logo container div */}
                        <div className="flex shrink-0 items-center">
                            <Image src={`/assets/logo.svg`} width={70} height={20} alt='Website Logo'  />
                        </div>

                        {/* large device navlinks container div */}
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        {/* Profile dropdown */}
                        {
                            ...
                            <button className="bg-[#fff] ml-3 px-5 py-1.5 rounded-md outline-none border border-[#FF3811] text-[#FF3811] font-medium">Appointment</button>
                        }
                    </div>
                </div>
            </div>
